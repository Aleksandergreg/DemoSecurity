package org.poll.jwtsecurity.config;

import org.poll.jwtsecurity.JwtAuthenticationEntryPoint;
import org.poll.jwtsecurity.JwtFilter;
...
public class SecurityConfiguration implements WebMvcConfigurer {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeHttpRequests().requestMatchers("/login", "/signup", "index.html", "login.html").permitAll()
